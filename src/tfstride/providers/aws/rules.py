...
from tfstride.providers.aws.ecs_dynamodb_table_topology_disruption_rules import (
    AwsEcsDynamoDbTableTopologyDisruptionRuleDetectors,
)
...
from tfstride.providers.aws.ecs_secret_management_rules import (
...
def build_aws_rule_contribution(
    ...
    ecs_dynamodb_table_topology_disruption_detectors = AwsEcsDynamoDbTableTopologyDisruptionRuleDetectors(
        finding_factory
    )
    ...
    ecs_messaging_topology_disruption_detectors = AwsEcsMessagingTopologyDisruptionRuleDetectors(finding_factory)
    ...
    detectors_by_rule_id: Mapping[str, RuleDetector] = {
        ...
        "aws-public-ecs-dynamodb-table-topology-disruption": (
            ecs_dynamodb_table_topology_disruption_detectors.detect_public_service_table_topology_disruption
        ),
        ...
        "aws-public-ecs-messaging-topology-disruption": (
            ecs_messaging_topology_disruption_detectors.detect_public_service_topology_disruption
        ),
