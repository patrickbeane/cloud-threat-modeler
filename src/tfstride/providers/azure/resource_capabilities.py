...
_POSTGRESQL_SERVERS = frozenset({AzureResourceType.POSTGRESQL_FLEXIBLE_SERVER})
_POSTGRESQL_DATA = frozenset(
    {AzureResourceType.POSTGRESQL_FLEXIBLE_SERVER, AzureResourceType.POSTGRESQL_FLEXIBLE_SERVER_DATABASE}
)

AZURE_RESOURCE_CAPABILITIES: ResourceCapabilityMap = MappingProxyType(
    {
        ResourceCapability.WORKLOAD: _VIRTUAL_MACHINES | _APP_SERVICES,
