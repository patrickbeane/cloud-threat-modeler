...
from tfstride.providers.azure.app_service_storage_container_topology_disruption_rules import (
    AzureAppServiceStorageContainerTopologyDisruptionRuleDetectors,
)
...
def build_azure_rule_contribution(
    ...
    detectors_by_rule_id: Mapping[str, RuleDetector] = {
        ...
        "azure-public-app-service-storage-container-topology-disruption": (
            app_service_storage_container_topology_detectors.detect_public_app_service_storage_container_topology_disruption
        ),
        "azure-public-app-service-cosmosdb-mutation-access": (
        ...
        "azure-app-service-key-vault-reference-identity-not-configured": (
            app_service_key_vault_detectors.detect_reference_identity_not_configured
        ),
        "azure-app-service-key-vault-secret-access-overprivileged": (
        ...
        "azure-public-app-service-key-vault-key-disruption": (
            app_service_key_vault_management_detectors.detect_public_app_service_key_vault_key_disruption
        ),
        "azure-public-app-service-key-vault-authorization-delegation": (
