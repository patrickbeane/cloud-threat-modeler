...
class AzureResourceMetadata:
    ...
    COSMOSDB_KEY_VAULT_KEY_ID = OptionalStringMetadataField("cosmosdb_key_vault_key_id")
    COSMOSDB_DEFAULT_IDENTITY_TYPE = OptionalStringMetadataField("cosmosdb_default_identity_type")
    COSMOSDB_BACKUP_CONFIGURATION_STATE = OptionalStringMetadataField("cosmosdb_backup_configuration_state")
    COSMOSDB_BACKUP_TYPE = OptionalStringMetadataField("cosmosdb_backup_type")
    COSMOSDB_BACKUP_TIER = OptionalStringMetadataField("cosmosdb_backup_tier")
    COSMOSDB_BACKUP_INTERVAL_MINUTES = OptionalIntMetadataField("cosmosdb_backup_interval_minutes")
    COSMOSDB_BACKUP_RETENTION_HOURS = OptionalIntMetadataField("cosmosdb_backup_retention_hours")
    COSMOSDB_BACKUP_STORAGE_REDUNDANCY = OptionalStringMetadataField("cosmosdb_backup_storage_redundancy")
    COSMOSDB_IP_RANGE_FILTER_STATE = OptionalStringMetadataField("cosmosdb_ip_range_filter_state")
    COSMOSDB_VIRTUAL_NETWORK_FILTER_STATE = OptionalStringMetadataField("cosmosdb_virtual_network_filter_state")
    COSMOSDB_VIRTUAL_NETWORK_RULE_STATE = OptionalStringMetadataField("cosmosdb_virtual_network_rule_state")
    COSMOSDB_NETWORK_ACL_BYPASS_STATE = OptionalStringMetadataField("cosmosdb_network_acl_bypass_state")
    COSMOSDB_NETWORK_ACL_BYPASS_IDS_STATE = OptionalStringMetadataField("cosmosdb_network_acl_bypass_ids_state")
    COSMOSDB_LOCAL_AUTHENTICATION_STATE = OptionalStringMetadataField("cosmosdb_local_authentication_state")
    COSMOSDB_AUTOMATIC_FAILOVER_STATE = OptionalStringMetadataField("cosmosdb_automatic_failover_state")
    COSMOSDB_MULTIPLE_WRITE_LOCATIONS_STATE = OptionalStringMetadataField("cosmosdb_multiple_write_locations_state")
    COSMOSDB_GEO_LOCATION_STATE = OptionalStringMetadataField("cosmosdb_geo_location_state")
    ...
    KEY_VAULT_KEY_NAME = OptionalStringMetadataField("key_vault_key_name")
    KEY_VAULT_KEY_URI = OptionalStringMetadataField("key_vault_key_uri")
    KEY_VAULT_KEY_VERSIONLESS_URI = OptionalStringMetadataField("key_vault_key_versionless_uri")
    KEY_VAULT_KEY_VERSION = OptionalStringMetadataField("key_vault_key_version")
    KEY_VAULT_KEY_RESOURCE_ID = OptionalStringMetadataField("key_vault_key_resource_id")
    ...
    ROLE_ASSIGNMENT_CONDITION_VERSION = OptionalStringMetadataField("role_assignment_condition_version")
    ...
    UNRESOLVED_SERVICE_BUS_TOPIC_REFERENCES = StringListMetadataField("unresolved_service_bus_topic_references")
