...
class GcpResourceType:
    ...
    ARTIFACT_REGISTRY_REPOSITORY_IAM_BINDING = "google_artifact_registry_repository_iam_binding"
    ARTIFACT_REGISTRY_REPOSITORY_IAM_MEMBER = "google_artifact_registry_repository_iam_member"
    ARTIFACT_REGISTRY_REPOSITORY_IAM_POLICY = "google_artifact_registry_repository_iam_policy"
...
GCP_ARTIFACT_REGISTRY_REPOSITORY_IAM_RESOURCE_TYPES = frozenset(
    {
