...
class GcpAttr:
    ...
    ALLOWED_AUDIENCES = StringListAttribute("allowed_audiences")
    ATTRIBUTE_CONDITION = OptionalStringAttribute("attribute_condition")
    ATTRIBUTE_MAPPING = DictAttribute("attribute_mapping")
    ...
    CHANNEL = OptionalStringAttribute("channel")
    CERTIFICATE_MAP = OptionalStringAttribute("certificate_map")
    ...
    CONNECTOR_ENFORCEMENT = OptionalStringAttribute("connector_enforcement")
    ...
    BINARY_AUTHORIZATION = DictListAttribute("binary_authorization")
    ...
    CLIENT_CERTIFICATE_CONFIG = DictListAttribute("client_certificate_config")
    CRYPTO_KEY = OptionalStringAttribute("crypto_key")
    CRYPTO_KEY_VERSION_ALGORITHM = OptionalStringAttribute("algorithm")
    CRYPTO_KEY_VERSION_PROTECTION_LEVEL = OptionalStringAttribute("protection_level")
    CRYPTO_KEY_VERSION_GENERATE_TIME = OptionalStringAttribute("generate_time")
    EXTERNAL_PROTECTION_LEVEL_OPTIONS = DictListAttribute("external_protection_level_options")
    CLUSTERING = ListAttribute("clustering")
    CRYPTO_KEY_ID = OptionalStringAttribute("crypto_key_id")
    CUSTOM_FEATURES = StringListAttribute("custom_features")
    DATASET = OptionalStringAttribute("dataset")
    DEFAULT_ACTION = OptionalStringAttribute("default_action")
    ...
    CLEANUP_POLICY_DRY_RUN = RawAttribute("cleanup_policy_dry_run")
    DELETION_PROTECTION_ENABLED = BoolAttribute("deletion_protection_enabled")
    CMEK_CONFIG = DictListAttribute("cmek_config")
    DATASET_ID = OptionalStringAttribute("dataset_id")
    DATABASE_ENCRYPTION = DictListAttribute("database_encryption")
    ...
    DOMAINS = StringListAttribute("domains")
    ...
    ENABLED_FEATURES = StringListAttribute("enabled_features")
    ENABLE_LEGACY_ABAC = RawAttribute("enable_legacy_abac")
    ...
    ENABLE_SHIELDED_NODES = RawAttribute("enable_shielded_nodes")
    ENDPOINT = OptionalStringAttribute("endpoint")
    ENABLED = BoolAttribute("enabled")
    ENABLE_COMPONENTS = StringListAttribute("enable_components")
    ENCRYPTION_CONFIGURATION = DictListAttribute("encryption_configuration")
    DOCKER_CONFIG = DictListAttribute("docker_config")
    CLEANUP_POLICIES = DictListAttribute("cleanup_policies")
    VULNERABILITY_SCANNING_CONFIG = DictListAttribute("vulnerability_scanning_config")
    EVALUATION_MODE = OptionalStringAttribute("evaluation_mode")
    ...
    LOCATION_ID = OptionalStringAttribute("location_id")
    LOGGING_CONFIG = DictListAttribute("logging_config")
    LOGGING_SERVICE = OptionalStringAttribute("logging_service")
    ...
    MIN_TLS_VERSION = OptionalStringAttribute("min_tls_version")
    ...
    MASTER_AUTH = DictListAttribute("master_auth")
    MANAGED = DictListAttribute("managed")
    ...
    NETWORK_POLICY = DictListAttribute("network_policy")
    ...
    PASSWORD = RawAttribute("password")
    POINT_IN_TIME_RECOVERY_ENABLED = BoolAttribute("point_in_time_recovery_enabled")
    POINT_IN_TIME_RECOVERY_ENABLEMENT = OptionalStringAttribute("point_in_time_recovery_enablement")
    DELETE_PROTECTION_STATE = OptionalStringAttribute("delete_protection_state")
    PRIVATE_CLUSTER_CONFIG = DictListAttribute("private_cluster_config")
    PRIVATE_NETWORK = OptionalStringAttribute("private_network")
    PSC_CONNECTION_ID = RawAttribute("psc_connection_id")
    ...
    RETENTION_DURATION_SECONDS = OptionalIntAttribute("retention_duration_seconds")
    RETENTION_PERIOD = OptionalIntAttribute("retention_period")
    RETENTION_POLICY = DictListAttribute("retention_policy")
    ...
    RUN_INVOKER_IAM_DISABLED_ANNOTATION = OptionalStringAttribute("run.googleapis.com/invoker-iam-disabled")
    RELEASE_CHANNEL = DictListAttribute("release_channel")
    ...
    SERVICE_LABEL = OptionalStringAttribute("service_label")
    SERVICE_NAME = OptionalStringAttribute("service_name")
    ...
    SHIELDED_NODES = DictListAttribute("shielded_nodes")
    ...
    STATE = OptionalStringAttribute("state")
    TEMPLATE = DictListAttribute("template")
    CONTAINERS = DictListAttribute("containers")
    ENV = DictListAttribute("env")
    VALUE_FROM = DictListAttribute("value_from")
    VALUE_SOURCE = DictListAttribute("value_source")
    SECRET_KEY_REF = DictListAttribute("secret_key_ref")
    ...
    TYPE = OptionalStringAttribute("type")
    ...
    USERNAME = OptionalStringAttribute("username")
    VALID_AFTER = OptionalStringAttribute("valid_after")
    KEY = OptionalStringAttribute("key")
    ...
    WORKLOAD_IDENTITY_POOL_ID = OptionalStringAttribute("workload_identity_pool_id")
    WORKLOAD_IDENTITY_POOL_PROVIDER_ID = OptionalStringAttribute("workload_identity_pool_provider_id")
    ...
    ENABLEMENT_CONFIG = OptionalStringAttribute("enablement_config")
    ENABLEMENT_STATE = OptionalStringAttribute("enablement_state")
    ENABLEMENT_STATE_REASON = OptionalStringAttribute("enablement_state_reason")
    DELETION_POLICY = OptionalStringAttribute("deletion_policy")
    ...
    SSL_POLICY = OptionalStringAttribute("ssl_policy")
    SECURITY_POLICY = OptionalStringAttribute("security_policy")
    EDGE_SECURITY_POLICY = OptionalStringAttribute("edge_security_policy")
