...
from cloud_threat_modeler.config import ProjectConfigLoadError, load_project_config
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        "--config",
        help=(
            "Optional path to a `cloud-threat-modeler.toml` config file. If omitted, the CLI "
...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        ...
        engine = CloudThreatModeler(rule_policy=project_config.rule_policy)
        title = args.title or project_config.title or "Cloud Threat Model Report"
