...
class RuleRegistryTests(unittest.TestCase):
    ...
    def test_default_rule_metadata_ids_match_locked_order(self) -> None:
        ...
        self.assertEqual(len(metadata), 292)
    ...
    def test_default_rule_metadata_is_partitioned_by_provider(self) -> None:
        ...
        self.assertEqual(len(aws_metadata_ids), 97)
        self.assertEqual(len(gcp_metadata_ids), 88)
        self.assertEqual(len(azure_metadata_ids), 107)
