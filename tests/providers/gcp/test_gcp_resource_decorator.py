    ...
    def test_default_decoration_stages_are_ordered_by_contract(self) -> None:
        self.assertEqual(
            ...
            [
                ...
                "model_cloud_run_logging_sink_audit_telemetry_disruption_paths",
                "normalize_secret_manager_version_posture",
                "normalize_secret_manager_iam_posture",
                ...
                "model_cloud_run_gcs_protected_data_convergence",
                "model_cloud_run_pubsub_access_paths",
                "model_cloud_run_pubsub_topology_destruction_paths",
                "model_cloud_run_pubsub_message_removal_paths",
                "model_cloud_run_secret_access_paths",
                "model_cloud_run_secret_management_paths",
                "model_cloud_run_artifact_registry_write_paths",
                "model_workload_identity_federation_trust_paths",
