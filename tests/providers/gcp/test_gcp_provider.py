    ...
    def test_metadata_namespace_exposes_gcp_owned_fields(self) -> None:
        self.assertGreaterEqual(
            _metadata_field_names(GcpResourceMetadata),
            {
                ...
                "CUSTOM_ROLE_STAGE",
                "CUSTOM_ROLE_DELETED",
                "CUSTOM_ROLE_DELETED_UNCERTAINTIES",
                "ORGANIZATION_ID",
                "FOLDER_ID",
                ...
                "CLOUD_RUN_KMS_MANAGEMENT_PATH_UNCERTAINTIES",
                "CLOUD_RUN_KMS_MANAGEMENT_PATHS",
                "KMS_KEY_RING_IAM_POSTURE_UNCERTAINTIES",
                "KMS_KEY_RING_IAM_GRANTS",
                ...
                "GCS_SOFT_DELETE_RETENTION_DURATION_SECONDS",
                "GCS_SOFT_DELETE_STATE",
                ...
                "SECRET_MANAGER_VERSION_REFERENCE",
                "SECRET_MANAGER_VERSION_NUMBER",
                "SECRET_MANAGER_VERSION_SECRET_REFERENCE",
                "SECRET_MANAGER_VERSION_RESOLVED_SECRET_ADDRESS",
                "SECRET_MANAGER_VERSION_LIFECYCLE_STATE",
                "SECRET_MANAGER_VERSION_DELETION_POLICY",
