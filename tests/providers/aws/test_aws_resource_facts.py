...
class AwsResourceFactsTests(unittest.TestCase):
    ...
    def test_s3_posture_facts_default_to_missing_when_not_modeled(self) -> None:
        ...
        self.assertIsNone(facts.s3_object_lock_source_address)
        self.assertEqual(facts.s3_object_lock_configuration, {})
        self.assertEqual(facts.s3_lifecycle_rules, [])
        self.assertIsNone(facts.s3_lifecycle_rule_count)
        self.assertIsNone(facts.s3_lifecycle_source_address)
