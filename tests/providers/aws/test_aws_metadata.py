...
class AwsResourceMetadataTests(unittest.TestCase):
    ...
    def test_aws_metadata_provider_fields_keep_existing_metadata_keys(self) -> None:
        expected_keys = {
            ...
            "IAM_PERMISSIONS_BOUNDARY_ARN": "iam_permissions_boundary_arn",
            "IAM_PERMISSIONS_BOUNDARY_STATE": "iam_permissions_boundary_state",
            "IAM_PERMISSIONS_BOUNDARY_UNCERTAINTIES": "iam_permissions_boundary_uncertainties",
            "BUCKET_NAME": "bucket",
            "BUCKET_ACL": "acl",
            ...
            "ECS_S3_OBJECT_DELETION_PATH_UNCERTAINTIES": ("ecs_s3_object_deletion_path_uncertainties"),
            ...
            "KMS_KEY_ORIGIN": "kms_key_origin",
            "KMS_MULTI_REGION_STATE": "kms_multi_region_state",
            "KMS_CUSTOM_KEY_STORE_ID": "kms_custom_key_store_id",
            "KMS_XKS_KEY_ID": "kms_xks_key_id",
            "KMS_ENABLE_KEY_ROTATION_STATE": "kms_enable_key_rotation_state",
            "KMS_POLICY_CONFIGURATION_STATE": "kms_policy_configuration_state",
            ...
            "KMS_ALIAS_TARGET_KEY_ID": "kms_alias_target_key_id",
            "KMS_ALIAS_TARGET_KEY_ARN": "kms_alias_target_key_arn",
            "KMS_ALIAS_TARGET_KEY_REFERENCE": "kms_alias_target_key_reference",
            "KMS_ALIAS_RESOLVED_KEY_ADDRESS": "kms_alias_resolved_key_address",
            "KMS_ALIAS_POSTURE_UNCERTAINTIES": "kms_alias_posture_uncertainties",
            "KMS_GRANT_ID": "kms_grant_id",
            "KMS_GRANT_NAME": "kms_grant_name",
            "KMS_GRANT_KEY_REFERENCE": "kms_grant_key_reference",
            "KMS_GRANT_GRANTEE_PRINCIPAL": "kms_grant_grantee_principal",
            "KMS_GRANT_OPERATIONS": "kms_grant_operations",
            "KMS_GRANT_RETIRING_PRINCIPAL": "kms_grant_retiring_principal",
            "KMS_GRANT_CONSTRAINTS": "kms_grant_constraints",
            "KMS_GRANT_RETIRE_ON_DELETE_STATE": "kms_grant_retire_on_delete_state",
            "KMS_GRANT_RESOLVED_KEY_ADDRESS": "kms_grant_resolved_key_address",
            "KMS_GRANT_POSTURE_UNCERTAINTIES": "kms_grant_posture_uncertainties",
            "KMS_KEY_POLICY_KEY_REFERENCE": "kms_key_policy_key_reference",
            "KMS_KEY_POLICY_RESOLVED_KEY_ADDRESS": "kms_key_policy_resolved_key_address",
            "KMS_KEY_POLICY_BYPASS_LOCKOUT_SAFETY_CHECK_STATE": "kms_key_policy_bypass_lockout_safety_check_state",
            "KMS_KEY_POLICY_POSTURE_UNCERTAINTIES": "kms_key_policy_posture_uncertainties",
            "KMS_DELETION_WINDOW_IN_DAYS": "kms_deletion_window_in_days",
            "KMS_ROTATION_PERIOD_IN_DAYS": "kms_rotation_period_in_days",
            ...
            "ECS_S3_OBJECT_DELETION_PATHS": "ecs_s3_object_deletion_paths",
            ...
            "CALLER_IDENTITY_ACCOUNT_ID": "caller_identity_account_id",
            "CALLER_IDENTITY_ACCOUNT_ID_STATE": "caller_identity_account_id_state",
            "CALLER_IDENTITY_USER_ID": "caller_identity_user_id",
            "CALLER_IDENTITY_POSTURE_UNCERTAINTIES": "caller_identity_posture_uncertainties",
