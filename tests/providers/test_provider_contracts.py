...
_GCP_PROMOTED_RULE_FACING_METADATA_FIELDS = (
    ...
    GcpResourceMetadata.GKE_LOGGING_SERVICE,
    GcpResourceMetadata.GKE_LOGGING_COMPONENTS,
    GcpResourceMetadata.GKE_CONTROL_PLANE_LOGGING_STATE,
    GcpResourceMetadata.GKE_LOGGING_CONFIG,
    GcpResourceMetadata.GKE_NETWORK_POLICY_STATE,
    GcpResourceMetadata.GKE_NETWORK_POLICY_PROVIDER,
    GcpResourceMetadata.GKE_NETWORK_POLICY,
    GcpResourceMetadata.GKE_DATABASE_ENCRYPTION_STATE,
    GcpResourceMetadata.GKE_DATABASE_ENCRYPTION_KEY_NAME,
    GcpResourceMetadata.GKE_SECRETS_ENCRYPTION_STATE,
    GcpResourceMetadata.GKE_DATABASE_ENCRYPTION,
    GcpResourceMetadata.GKE_LEGACY_ABAC_ENABLED,
    GcpResourceMetadata.GKE_LEGACY_ABAC_STATE,
    GcpResourceMetadata.GKE_CLIENT_CERTIFICATE_AUTH_ENABLED,
    GcpResourceMetadata.GKE_CLIENT_CERTIFICATE_AUTH_STATE,
    GcpResourceMetadata.GKE_BASIC_AUTH_STATE,
    GcpResourceMetadata.GKE_BASIC_AUTH_USERNAME,
    GcpResourceMetadata.GKE_BASIC_AUTH_PASSWORD_CONFIGURED,
    GcpResourceMetadata.GKE_MASTER_AUTH,
    GcpResourceMetadata.GKE_CLIENT_CERTIFICATE_CONFIG,
    GcpResourceMetadata.GKE_RELEASE_CHANNEL,
    GcpResourceMetadata.GKE_RELEASE_CHANNEL_CONFIG,
    GcpResourceMetadata.GKE_SHIELDED_NODES_ENABLED,
    GcpResourceMetadata.GKE_SHIELDED_NODES_STATE,
    GcpResourceMetadata.GKE_SHIELDED_NODES_CONFIG,
    GcpResourceMetadata.GKE_BINARY_AUTHORIZATION_EVALUATION_MODE,
    GcpResourceMetadata.GKE_BINARY_AUTHORIZATION_STATE,
...
class ProviderEncapsulationContractTests(unittest.TestCase):
    ...
    def test_resource_metadata_ownership_contract_marks_known_boundaries(self) -> None:
        ...
        self.assertIn("ARTIFACT_REGISTRY_REPOSITORY_PATH", gcp_owned)
        self.assertIn("CONTAINER_IMAGE_REFERENCES", gcp_owned)
        self.assertIn("CONTAINER_IMAGE_POSTURE_UNCERTAINTIES", gcp_owned)
        ...
        self.assertIn("EKS_ENDPOINT_PUBLIC_ACCESS_STATE", aws_owned)
        self.assertIn("EKS_ENABLED_CLUSTER_LOG_TYPES", aws_owned)
        self.assertIn("EKS_SECRETS_ENCRYPTION_STATE", aws_owned)
        self.assertIn("EKS_AUTHENTICATION_MODE", aws_owned)
        self.assertIn("LAMBDA_FUNCTION_URL_AUTHORIZATION_TYPE", aws_owned)
        self.assertIn("CONTAINER_IMAGE_REFERENCES", aws_owned)
        self.assertIn("CONTAINER_IMAGE_POSTURE_UNCERTAINTIES", aws_owned)
        self.assertIn("LAMBDA_PACKAGE_TYPE", aws_owned)
        self.assertIn("ECR_REPOSITORY_URL", aws_owned)
        self.assertIn("LAMBDA_FUNCTION_URL_CORS", aws_owned)
        self.assertIn("LAMBDA_FUNCTION_URL_POSTURE_UNCERTAINTIES", aws_owned)
        self.assertIn("VPC_ENDPOINT_SERVICE_NAME", aws_owned)
        self.assertIn("VPC_ENDPOINT_PRIVATE_DNS_ENABLED_STATE", aws_owned)
        self.assertIn("VPC_ENDPOINT_DNS_ENTRIES", aws_owned)
