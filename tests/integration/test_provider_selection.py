...
class ProviderSelectionIntegrationTests(TFSIntegrationTestCase):
    ...
    def test_analysis_uses_same_active_registry_for_evaluation_and_coverage(self) -> None:
        ...
        self.assertEqual(result.analysis_coverage.rules.registered_rule_count, 93)
        self.assertEqual(len(result.analysis_coverage.rules.enabled_rules), 93)
    ...
    def test_analysis_auto_selects_gcp_provider_for_google_plan(self) -> None:
        ...
        self.assertEqual(result.findings, [])
        self.assertEqual(result.analysis_coverage.rules.registered_rule_count, 86)
        self.assertEqual(len(result.analysis_coverage.rules.enabled_rules), 86)
    ...
    def test_analysis_auto_selects_azure_storage_provider(self) -> None:
        ...
        self.assertEqual(result.findings, [])
        self.assertEqual(result.analysis_coverage.rules.registered_rule_count, 105)
        self.assertEqual(len(result.analysis_coverage.rules.enabled_rules), 105)
